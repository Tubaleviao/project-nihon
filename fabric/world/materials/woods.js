...
module.exports = {
  ...
  Thornwood: defineEntity({
    ...
    fields: {
      ...
      density:      { type: 'decimal', description: 'g/cm³; heavier than most woods', defaultValue: 0.85 },
  ...
  Duskfiber: defineEntity({
    ...
    fields: {
      ...
      density:      { type: 'decimal', description: 'g/cm³; extremely low — used as fibre not lumber', defaultValue: 0.15 },
